...
public class Karyawan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtNIK, new org.netbeans.lib.awtextra.AbsoluteConstraints(213, 93, 144, -1));
        ...
        cbJabatan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ADM (Administerateur)", "Database Administrator", "Krani Besar", "Asisten", "Kepala Bagian", "Direksi", "IT Engineer" }));
        cbJabatan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbJabatanActionPerformed(evt);
            }
        });
        getContentPane().add(cbJabatan, new org.netbeans.lib.awtextra.AbsoluteConstraints(213, 155, 185, -1));
